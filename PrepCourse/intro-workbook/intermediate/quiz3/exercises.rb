...
# Exercise 3
# Only my_array is modified. While both passes the value of the reference, only
# my_array variable makes use of the original reference that was passed. The
# string variable creates a new string object. In short, the my_array acts like
# a pass by reference of other programming languages. This is more likely to
# accommodate that an array may point or have multiple values.

# Exercise 4
# The string was mutated in place
# The array was reassigned so it created a new array object.
